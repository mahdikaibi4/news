              ...
              return (
                <Sequence key={`hero-${idx}`} from={startFrame} style={{ position: 'absolute', inset: 0 }}>
                  <div style={{
                    ...
                    {assetSrc && {assetSrc && {assetSrc && {assetSrc && {assetSrc && <Img src={getAsset(assetSrc)} style={{ maxHeight: '1100px', objectFit: 'contain', filter: 'drop-shadow(0 50px 80px rgba(0,0,0,0.9))' }} />}}}}}
                  </div>
                </Sequence>
              );
            }
                ...
                <Sequence key={`prop-${idx}`} from={startFrame} style={{ position: 'absolute', inset: 0 }}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {evt.local_path && {evt.local_path && {evt.local_path && {evt.local_path && {evt.local_path && <Img src={getAsset(evt.local_path)} style={{ maxHeight: '550px', maxWidth: '800px', objectFit: 'contain' }} />}}}}}
                    </div>
                  </div>
                </Sequence>
              );
                  ...
                  <Sequence key={`swarm-${idx}-${swarmIdx}`} from={startFrame} style={{ position: 'absolute', inset: 0 }}>
                    <div style={{
                      ...
                      <div style={{
                        ...
                        {evt.local_path && {evt.local_path && {evt.local_path && {evt.local_path && {evt.local_path && <Img src={getAsset(evt.local_path)} style={{ maxHeight: '350px', objectFit: 'cover' }} />}}}}}
                      </div>
                    </div>
                  </Sequence>
                );
